...
UPDATE Concert SET Lineup = (SELECT concert_id FROM Lineup WHERE Concert.Cid = Lineup.concert_id);
...
---Avis Concerts---
INSERT INTO Avis_Concert (Note, Commentaire) VALUES 
(3, 'Le concert était moyen'),
